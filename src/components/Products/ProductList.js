...
const toggleDialogSize = () => {
    ...
    const fetchCategories = () => {
        setLoading(true);
        fetch("https://guided-selling-assistant.onrender.com/fourth_level_categories/")
...
// Fetch filters based on categoryId
  ...
  const fetchFilters = (categoryId) => {
    ...
    fetch(`https://guided-selling-assistant.onrender.com/category_filters/?category_id=${categoryId}`, {
        method: 'GET',
        headers: {
